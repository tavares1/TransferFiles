 ...
 implements TransferApp.TransferOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("requisitarListaDeArquivos", new java.lang.Integer (4));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // TransferApp/Transfer/requisitarListaDeArquivos
       {
         String user = in.read_string ();
         String $result[] = null;
         $result = this.requisitarListaDeArquivos (user);
         out = $rh.createReply();
         PathListHelper.write (out, $result);
         break;
       }

       case 5:  // TransferApp/Transfer/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
