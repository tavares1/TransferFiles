 ...
 implements TransferApp.TransferOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("requisitarListaDeArquivos", new java.lang.Integer (2));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 2:  // TransferApp/Transfer/requisitarListaDeArquivos
       {
         String user = in.read_string ();
         String $result[] = null;
       ...
       case 3:  // TransferApp/Transfer/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
