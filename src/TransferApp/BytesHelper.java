...
{
  private static String  _id = "IDL:TransferApp/Bytes:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (TransferApp.BytesHelper.id (), "Bytes", __typeCode);
    }
    return __typeCode;
  }
